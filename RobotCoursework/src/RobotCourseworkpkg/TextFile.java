...
public class TextFile {
    ...
    /**
     * constructor used to set up object ... pass it the description of files
     * and extension
     *
    ...
    public TextFile(String ftypeD, String fExtension) {
        ...
        chooser.setFileSelectionMode(JFileChooser.FILES_AND_DIRECTORIES);   // set chooser up to find files & dirs
    ...
    /**
     * report name of file used for reading/writing - empty string if
    ...
    public static void main(String[] args) {                                // Code to test text file class
